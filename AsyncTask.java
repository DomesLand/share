 ...
 */
@Deprecated
// 定义了三个泛型类型(T,S,V)，对应传入参数，中间值，结果值
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    static {
        // 核心线程数为1,但是使用了SynchronousQueue，多余的任务会直接创建线程执行，所以是并发的
    ...
    public AsyncTask(@Nullable Looper callbackLooper) {
        ...
        mWorker = new WorkerRunnable<Params, Result>() {
            public Result call() throws Exception {
                ...
                try {
                    ...
                    // 在用户线程要进入阻塞之前跟内核线程发送消息，防止用户线程长时间的持有某个对象
        ...
        // 将创建好的WorkerRunnable封装为FutureTask,使用FutureTask的目的就是为了获取结果值
    ...
    private void finish(Result result) {
        if (isCancelled()) {
            ...
            // 回调结果，从前面Handler绑定的是主线程,所以该方法运行在主线程
