...
public abstract class IntentService extends Service {
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            // 调用onHandleIntent回调
            // 因为前面ServiceHandler绑定的是创建的HandlerThread的Looper,所以这个运行在子线程
    ...
    // Service的onStart已经废弃了，使用onStartCommand代替，但为了向后兼容，会在onStartCommand中调用onStart
    @Override
    ...
    public int onStartCommand(@Nullable Intent intent, int flags, int startId) {
        ...
        // START_REDELIVER_INTENT ： Service被杀死后会重新启动并携带之前的Intent信息
        // START_NOT_STICKY : Service被杀死后不会进行重启，默认
